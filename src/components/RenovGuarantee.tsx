          ...
          >
            <div>
              ...
              <div className="flex items-center gap-3 mb-6 sm:mb-8">
                ...
                <span className="text-accent text-[9px] sm:text-[10px] font-black uppercase tracking-[0.4em] sm:tracking-[0.5em]">
                  Our Promise
                </span>
              </div>
              ...
              <h2 className="text-[2.4rem] xs:text-[2.8rem] sm:text-5xl md:text-6xl lg:text-[5.5rem] xl:text-[7rem] font-black text-foreground uppercase tracking-tighter leading-[0.85] italic">
                Free<br />
                <span className="text-accent">Renov</span><br />
                Guarantee
              </h2>
            </div>
            ...
            <div className="space-y-3 sm:space-y-4 max-w-lg">
              ...
              <p className="text-foreground/60 text-sm sm:text-base leading-relaxed">
                ...
                <strong className="text-accent">the cost of your service is on us.</strong>
              </p>
            </div>
            ...
            <motion.a
              href="#contact"
              whileHover={{ x: 4 }}
              className="group self-start inline-flex items-center gap-3 sm:gap-5 bg-accent text-white px-6 sm:px-10 py-4 sm:py-5 font-black uppercase tracking-[0.15em] sm:tracking-[0.25em] text-[10px] sm:text-xs hover:bg-accentDark transition-colors w-full sm:w-auto justify-center sm:justify-start"
            >
          ...
          >
            ...
            <div className="flex items-center gap-4 sm:gap-6 pb-8 sm:pb-10 border-b border-border">
              ...
              <div>
                ...
                <p className="text-accent font-black uppercase tracking-wider text-xs sm:text-sm leading-tight">Guarantee</p>
                <div className="flex gap-0.5 sm:gap-1 mt-1.5 sm:mt-2">
                  {[...Array(5)].map((_, i) => (
                    <Star key={i} className="w-2.5 h-2.5 sm:w-3 sm:h-3 text-accent fill-accent" />
                  ))}
                </div>
              </div>
            </div>
