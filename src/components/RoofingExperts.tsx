  ...
  ({
    ...
    return (
      <motion.div
        ...
        className="relative p-3 sm:p-4 rounded-xl sm:rounded-2xl shadow-md transition-all duration-300 w-full transform-gpu"
        style={{ background: "hsl(var(--card))", border: "1px solid hsl(var(--border))" }}
      >
        <div className="relative">
          <span className="text-2xl sm:text-3xl md:text-4xl font-black" style={{ color: "hsl(var(--primary))" }}>
            <Counter value={value} suffix={suffix} />
          </span>
          <div className="absolute -bottom-1 sm:-bottom-2 left-0 w-8 sm:w-12 h-0.5 rounded-full" style={{ background: "hsl(var(--primary))" }} />
        </div>
        <p className="text-[10px] sm:text-xs font-bold mt-3 leading-tight uppercase tracking-wide text-muted-foreground">
          {label}
        </p>
      </motion.div>
    );
...
export default function AboutSection() {
  ...
  return (
    <section
      ...
      aria-label="About Garnet Companies"
    >
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 xl:gap-16 items-stretch ">
          ...
          >
            ...
            >
              ...
              <span className="uppercase tracking-[0.2em] text-xs font-black" style={{ color: "hsl(var(--primary))" }}>
                {badge}
              </span>
            </motion.div>
              ...
              >
                {coreValues.map((value: string) => (
                  <span
                    ...
                    style={{ background: "hsl(var(--color-input-bg))", color: "hsl(var(--foreground))", border: "1px solid hsl(var(--color-border-light))" }}
                  >
                    {value}
                  </span>
                ))}
                ...
                {buttons.map((button: any, idx: number) =>
                  button.primary ? (
                    <motion.a
                      ...
                      style={{ background: "hsl(var(--primary))", color: "hsl(var(--primary-foreground))", boxShadow: "0 8px 32px hsl(var(--primary)/0.25)" }}
                    >
                      <span
                        className="
            ...
            "
                    ...
                    <motion.a
                      ...
                      whileTap={{ scale: 0.98 }}
                      className="group relative overflow-hidden w-full sm:w-auto md:w-auto min-w-[180px] sm:min-w-[200px] md:min-w-[180px] lg:min-w-[200px] px-5 sm:px-8 md:px-6 lg:px-8 py-3 sm:py-4 md:py-3.5 lg:py-4 rounded-2xl inline-flex items-center justify-center gap-2 font-semibold sm:font-bold text-sm sm:text-base transition-all duration-300"
                      style={{ background: "hsl(var(--color-dark))", color: "hsl(var(--color-white))", border: "2px solid hsl(var(--color-dark))", boxShadow: "0 8px 32px rgba(0,0,0,0.15)" }}
                    >
                      <span
                        className="
              absolute inset-0 opacity-0 group-hover:opacity-100
