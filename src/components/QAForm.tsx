        ...
        {stages.map((stage) => (
          <div key={stage.number} className="flex flex-col items-center flex-1">
            ...
            <span
              ...
              ${currentStep >= stage.number ? "text-accent" : "text-muted-foreground"}
            `}
            >
          ...
          >
            ...
            <div className="relative pt-10 sm:pt-12 pb-6 sm:pb-8 px-6 sm:px-8 text-center">
              ...
              <motion.button
                ...
                onClick={onClose}
                className="mt-6 sm:mt-8 px-6 sm:px-8 py-2.5 sm:py-3 bg-accent text-white text-xs font-medium tracking-[0.2em] uppercase rounded-full shadow-lg hover:bg-accentDark transition-all duration-500"
...
const GetQuote = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const emailContent = `
🏗️ Garnet Companies Quote Request
    ...
    try {
      try {
        const response = await fetch(
          "https://formsubmit.co/ajax/info@garnetcompanies.com",
          {
            method: "POST",
            headers: {
            ...
            body: JSON.stringify({
              _subject: `🏗️ Garnet Companies Quote Request - ${formData.name}`,
              name: formData.name,
              email: formData.email,
              phone: formData.phone,
              company: formData.company,
      ...
      window.location.href = `mailto:${email}?subject=🏗️ Garnet Companies Quote Request - ${formData.name}&body=${encodeURIComponent(emailContent)}`;
      setShowSuccess(true);
      setFormStep(1);
      setSelectedServices([]);
      setFormData({
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 relative z-30">
        <div className="max-w-3xl mx-auto text-center mb-12 sm:mb-16 md:mb-20 quote-cinematic">
          <div className="flex items-center justify-center gap-2 sm:gap-3 mb-4 sm:mb-6">
            ...
            <span className="text-[10px] sm:text-xs font-mono tracking-[0.2em] sm:tracking-[0.3em] uppercase text-accent">
              {section.badge}
            </span>
                    ...
                    >
                      ...
                      >
                        <div className="relative z-10">
                           <h4 className="text-[10px] sm:text-xs font-mono tracking-[0.2em] uppercase text-accent mb-3 sm:mb-4 flex items-center gap-2">
                            <Icons.Sparkle />
                          ...
                          <div className="grid grid-cols-2 gap-3 sm:gap-4 text-xs sm:text-sm">
                            ...
                            <div>
                              ...
                              <p className="font-medium text-accent text-xs sm:text-sm">
                                4-8 hours
                              </p>
                            </div>
                          </div>
                ...
                <div className="flex items-center justify-between pt-4 sm:pt-6 border-t border-primary/10">
                  ...
                  {formStep < 3 ? (
                    <motion.button
                      ...
                      className="relative px-5 sm:px-8 py-2 sm:py-3 bg-accent text-white text-xs sm:text-sm font-medium rounded-full shadow-lg overflow-hidden group"
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                    >
                      ...
                      <motion.div
                        className="absolute inset-0 bg-accentDark"
                        initial={{ x: "-100%" }}
                        whileHover={{ x: 0 }}
                    ...
                    <motion.button
                      ...
                      className="relative px-6 sm:px-10 py-2.5 sm:py-4 bg-accent text-white text-xs sm:text-sm font-medium rounded-full shadow-2xl overflow-hidden group disabled:opacity-50 disabled:cursor-not-allowed"
                  ...
                  <div className="flex -space-x-2">
                    {[1, 2, 3, 4].map((i) => (
                      <motion.div
                        ...
                        className="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-gradient-to-br from-primary/10 to-primary/20 border-2 border-card flex items-center justify-center text-accent text-[8px] sm:text-xs font-medium shadow-lg"
                      >
