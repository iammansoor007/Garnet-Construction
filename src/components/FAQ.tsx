        ...
        >
          <div className="flex items-center justify-between gap-6">
            <h3 className={`
              ...
              ${isOpen
                ? 'text-transparent bg-clip-text bg-gradient-to-r from-accent to-accent/80 font-medium'
                    ...
                    >
                      {item.links.map((link: any, i: number) => (
                        <motion.a
                          ...
                          href={link.url}
                          whileHover={{ x: 5 }}
                          className="inline-flex items-center gap-1.5 text-xs font-medium text-accent hover:text-accent/80 transition-colors group"
                        >
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 relative z-10">
        <div className="max-w-3xl mx-auto text-center mb-12 md:mb-16 faq-reveal">
          ...
          <div className="w-16 h-0.5 bg-gradient-to-r from-accent to-accent/60 mx-auto mt-6 rounded-full" />
        </div>
          ...
          {filteredItems.length > 0 ? (
            ...
            >
              ...
              <button
                ...
                className="mt-4 text-sm text-accent hover:text-accent/80 underline underline-offset-4"
              >
                Clear filters
              </button>
            </motion.div>
