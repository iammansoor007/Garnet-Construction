        ...
        <div className="flex items-center justify-between gap-6 pt-8 border-t border-border mt-auto">
          <div className="flex items-center gap-4 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <p className="text-xs md:text-sm text-accent font-bold uppercase tracking-[0.2em] mt-1">
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="max-w-3xl mx-auto text-center mb-10 md:mb-12 lg:mb-16 reveal-element">
            <span className="text-[10px] md:text-xs font-medium tracking-[0.2em] uppercase text-accent mb-2 md:mb-3 block">
              {section.badge}
            </span>
          ...
          <div className="max-w-4xl mx-auto mb-12 md:mb-16 lg:mb-20">
            ...
            <div className="flex items-center justify-between mt-4 md:mt-6">
              <div className="flex items-center gap-2">
                <span className="text-xs md:text-sm font-mono font-medium text-accent">
          ...
          <div className="mb-12 md:mb-16 lg:mb-20 reveal-element">
            <div className="flex items-center gap-2 md:gap-3 mb-4 md:mb-6">
              ...
              <span className="text-[10px] md:text-xs text-accent ml-auto">
            ...
            <div className="text-center mt-4 md:mt-6">
              <a
                ...
                className="inline-flex items-center gap-2 text-xs md:text-sm text-accent hover:text-accentDark transition-colors"
              >
                <Icons.Google />
            ...
            <div className="flex items-center gap-2 md:gap-3">
              <div className="flex -space-x-2">
                {testimonials.slice(0, 4).map((t: any, i: number) => (
                  <div key={i} className="w-6 h-6 md:w-8 md:h-8 rounded-full bg-gradient-to-br from-primary/10 to-primary/20 border-2 border-card flex items-center justify-center text-accent text-[8px] md:text-xs font-medium shadow-sm">
                    {t.avatar}
                  </div>
                ))}
              </div>
